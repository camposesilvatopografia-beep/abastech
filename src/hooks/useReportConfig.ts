...
const DEFAULT_COLUMNS: Record<string, ReportColumnConfig[]> = {
  lancamentos_tanques: [
    ...
    { key: 'descricao', label: 'Descrição', visible: true, order: 3, width: 38 },
    { key: 'motorista', label: 'Motorista', visible: true, order: 4 },
    { key: 'empresa', label: 'Empresa', visible: true, order: 5, width: 26 },
    { key: 'quantidade', label: 'Qtd (L)', visible: true, order: 6, width: 18 },
    { key: 'consumo', label: 'Consumo', visible: true, order: 7, width: 24 },
    { key: 'hor_ant', label: 'Hor/Km Ant.', visible: true, order: 8, width: 22 },
    { key: 'hor_atual', label: 'Hor/Km Atual', visible: true, order: 9, width: 22 },
    { key: 'intervalo', label: 'Intervalo', visible: true, order: 10, width: 22 },
  ],
  lancamentos_comboios: [
    ...
    { key: 'empresa', label: 'Empresa', visible: true, order: 5, width: 26 },
    { key: 'quantidade', label: 'Qtd (L)', visible: true, order: 6, width: 18 },
    { key: 'hor_ant', label: 'Hor/Km Ant.', visible: true, order: 7, width: 22 },
    { key: 'hor_atual', label: 'Hor/Km Atual', visible: true, order: 8, width: 22 },
    { key: 'intervalo', label: 'Intervalo', visible: true, order: 9, width: 22 },
    { key: 'consumo', label: 'Consumo', visible: true, order: 10, width: 24 },
  ],
  horimetros_resumo: [
