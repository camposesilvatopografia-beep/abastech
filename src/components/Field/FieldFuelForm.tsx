  ...
  const handleSaveInner = async () => {
    ...
    try {
      ...
      const recordData = {
        ...
        operator_name: recordType === 'entrada' ? '' : (operatorName || (userLocationInfo.isTanqueUser ? '' : user.name)),
        company,
        work_site: workSite,
      ...
      const syncSuccess = await syncToGoogleSheets({
        ...
        category: recordType === 'entrada' ? 'ENTRADA' : category,
        operatorName: recordType === 'entrada' ? '' : (operatorName || (userLocationInfo.isTanqueUser ? '' : user.name)),
        company,
        workSite,
